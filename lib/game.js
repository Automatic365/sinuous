...
function Game(canvas, context){
  ...
  Game.prototype.getRandomInput = function(min, max) {
    return Math.floor(Math.random() * (max - min + 1)) + min;
  }

  Game.prototype.createEnemies = function(number, enemies) {
  ...
  Game.prototype.createPowerups = function(number, powerups) {
    for (var i = 0; i < number; i++) {
  ...
  Game.prototype.collisionDetectionEnemy = function(player, enemies) {
  ...
  Game.prototype.collisionDetectionPowerup(player, powerups) {
  ...
  function gameOver(player) {
    ...
    context.fillText(player.score, 350, 225);
